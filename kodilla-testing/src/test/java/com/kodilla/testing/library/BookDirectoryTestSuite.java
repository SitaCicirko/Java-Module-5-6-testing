...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "123456789");

        List<Book> borrowedBooks = new ArrayList<>();
        borrowedBooks.add(new Book("Title 1", "Author 1", 2000));
        borrowedBooks.add(new Book("Title 2", "Author 2", 2005));
        borrowedBooks.add(new Book("Title 3", "Author 3", 2010));
        ...
        assertEquals(borrowedBooks, theListOfBooks);
